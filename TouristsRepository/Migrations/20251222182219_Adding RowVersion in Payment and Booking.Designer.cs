...
namespace TouristsRepository.Migrations
{
    ...
    [Migration("20251222182219_Adding RowVersion in Payment and Booking")]
    partial class AddingRowVersioninPaymentandBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TouristsCore.Entities.TourSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TouristsCore.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("TouristsCore.Entities.TourSchedule", "TourSchedule")
                        .WithMany("Bookings")
                        .HasForeignKey("TourScheduleId");

                    b.HasOne("TouristsCore.Entities.TouristProfile", "Tourist")
                        .WithMany()
            ...
            modelBuilder.Entity("TouristsCore.Entities.Chat", b =>
                {
                    b.HasOne("TouristsCore.Entities.Message", "LastMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("TouristsCore.Entities.Message", b =>
                {
                    ...
                    b.HasOne("TouristsCore.Entities.Message", "ReplyToMessage")
            ...
            modelBuilder.Entity("TouristsCore.Entities.TourMedia", b =>
                {
                    b.HasOne("TouristsCore.Entities.FileRecord", "File")
                        .WithMany()
            ...
            modelBuilder.Entity("TouristsCore.Entities.User", b =>
                {
                    b.OwnsMany("TouristsCore.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
